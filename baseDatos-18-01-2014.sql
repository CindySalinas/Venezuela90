...
--
-- Servidor: localhost
-- Tiempo de generación: 19-01-2014 a las 04:19:50
...
CREATE TABLE IF NOT EXISTS `cancelacion_mensualidades` (
  ...
  `monto_txt` varchar(100) COLLATE utf8_spanish2_ci NOT NULL,
...
INSERT INTO `docente` (`Id_Docente`, `Cedula`, `Descripcion`, `fecha_nacimiento`, `lugar_nacimiento`) VALUES
(1, '76543210', 'Una gringa bien chevere de un video', '18/01/2014', 'New York'),
(2, '01234567', 'My brother xd', '11/03/1993', 'San Diego'),
(3, '21029954', 'Keilyyyyyyy', '24/04/1991', 'Prebo');
...
INSERT INTO `estudiante` (`Id_Estudiante`, `Id_Grado`, `Id_Seccion`, `Id_Religion`, `Entidad`, `Fecha_Nacimiento`, `Lugar_Nacimiento`, `Fecha_Ingreso`, `Id_Representante_Emergencia`, `Id_Year`, `Cedula`) VALUES
(1, 1, 3, 1, 'aa', '26/02/1999', 'San Diego', '', 1, 1, '26580756'),
(2, 1, 3, 1, 'aa', '06/10/1998', 'Guacara', '', 2, 1, '26581529'),
(3, 1, 3, 2, 'aa', '14/04/1999', 'Maturin', '', 3, 1, '26634620'),
(4, 1, 3, 3, 'aa', '14/07/1998', 'Prebo', '', 4, 1, '26642123'),
(5, 1, 3, 2, 'aa', '19/10/1997', 'Prebo', '', 5, 1, '26917254');
...
--
-- Volcado de datos para la tabla `estudiante_mat_doc`
--

INSERT INTO `estudiante_mat_doc` (`id_estudiante_mat_doc`, `id_est`, `id_mat_docente`) VALUES
(1, 1, 1),
(2, 2, 1),
(3, 3, 1),
(4, 4, 1),
...
INSERT INTO `materia_docente` (`Id_Materia_Docente`, `Id_Docente`, `Id_Materia`, `Descripcion`) VALUES
(1, 2, 1, 'Prof Castellano'),
(2, 1, 10, 'Prof Quimica'),
(3, 3, 5, 'Prof Ingles');
...
--
-- Volcado de datos para la tabla `respuestasforos`
--
...
INSERT INTO `year` (`Id_Year`, `Year`, `Descripcion`) VALUES
(1, '1er Año', ''),
(2, '2do Año', ''),
(3, '3er Año', ''),
(4, '4to Año', ''),
