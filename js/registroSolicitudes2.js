...
function crearSolicitud(){
	...
	var url = "http://127.0.0.1:8080/Venezuela90/JsonVenezuela90/crearSolicitud2.php?jsoncallback=?";
	$('#del > tr').remove();
	if(mensaje != ""){
		if(primer == 1){
...
function realizarBusqueda(){
	...
	var tablas = $('#tbodyGS');
	/*var resp;*/
	var url = "http://127.0.0.1:8080/Venezuela90/JsonVenezuela90/mostrarSolicitudes2.php?jsoncallback=?"; 
