...
$sql = "Select Id_Mensaje, Correo_Remitente, Correo_Destinatario, Asunto_Mensaje, Mensaje FROM mensajes Where Correo_Destinatario='$correo' order by Id_Mensaje DESC";
...
if($cantidad == 0){
	$estado["num"] = 0;
	$estado["mensaje"]= "No Tiene Mensajes Nuevos";
}
