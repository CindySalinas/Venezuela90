...
while($row = mysql_fetch_row($result)){
	...
	$sql2 = " SELECT U.Nombre, U.Apellido,M.Nombre_Materia FROM usuario U INNER JOIN docente D ON D.Cedula = U.Cedula INNER JOIN materia_docente MD ON MD.Id_Docente = D.Id_Docente INNER JOIN materia M ON M.Id_Materia = MD.Id_Materia WHERE D.Cedula = '$row[2]'";
