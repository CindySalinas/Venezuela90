...
$sql = "Select Id_Mensaje, Correo_Remitente, Correo_Destinatario, Asunto_Mensaje, Mensaje FROM mensajes Where Correo_Remitente='$correo' order by Id_Mensaje DESC";
