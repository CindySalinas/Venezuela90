...
--
-- Servidor: localhost
-- Tiempo de generación: 13-02-2014 a las 13:54:30
...
CREATE TABLE IF NOT EXISTS `estudiante_materia_docente_nota` (
  ...
  `Puntos_Obtenidos` decimal(10,1) NOT NULL,
  `Descripcion` varchar(100) COLLATE utf8_spanish_ci NOT NULL,
...
(8, 3, 10, 1, 15, '12', '3.0', 'Examen 1'),
(9, 1, 10, 1, 10, '20', '2.0', 'Examen 1'),
(10, 2, 10, 1, 20, '20', '4.0', 'Examen 1'),
(11, 4, 10, 1, 12, '20', '2.0', 'Examen 1'),
(12, 5, 10, 1, 20, '20', '4.0', 'Examen 1'),
(13, 5, 10, 1, 15, '20', '4.0', 'Examen 2'),
(14, 5, 10, 1, 14, '20', '3.0', 'Examen 3'),
(15, 5, 10, 1, 12, '20', '2.4', 'Examen 4');
...
INSERT INTO `foto_perfil_usuario` (`Id_Foto_Perfil`, `Ruta_Foto_Perfil`, `Descripcion`) VALUES
(1, 'Archivo/logo.png', '');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=155 ;
...
(153, 'keily424@hotmail.com', 'abrantepedro@gmail.com', 'Comunicado', 'Buenos Dias', 'Jueves, 13 de Febrero de 2014', '8:01:14am', 'false', 'true'),
(154, 'keily424@hotmail.com', 'talaveramilena@gmail.com', 'Comunicado', 'Buenos Dias', 'Jueves, 13 de Febrero de 2014', '8:01:14am', 'false', 'false');
...
(11, 'Cleinderman Javier', 'Herrada Rodriguez', '26917254', 'herradajavier@venezuela90.com', '26917254', 2, '1', 'Venezolano', '32104569878', 'Prebo', 3, 1),
